//package com.capgemini.cn.myoffice.utils;
//
...
//     * description:控制学习申报信息类的属性输入正确
//     * create time: 0:52 2019/8/22
//     */
//    public String validataStaffStudy(StaffStudy staffStudy){
//        if(staffStudy.getEmpId() == null){
//            return "empId为空";
//        }
//
//        //英孚等级是否有要求，暂时不写
////        if (staffStudy.getChineseName() == null ||)
//        return "Success";
//    }
//
//
//    /**
//     * create by: MmmLll_Shen
//     * description:控制转团队信息类的属性输入正确
//     * create time: 22:49 2019/8/23
//     */
//    public String validataTeamChange(TeamChange teamChange){
//        if(teamChange.getEmpId() == null){
//            return "empId为空";
//        }
//
//        //英孚等级是否有要求，暂时不写
